...
Scenario: The user logs in successfully with valid credentials
  ...
  When I fill the username field with "existinguser" and I fill the password field with "ValidPassword123" and I press submit
...
Scenario: The user logs in with an incorrect username
  Given A user with username "existinguser" and password "ValidPassword123" is registered
